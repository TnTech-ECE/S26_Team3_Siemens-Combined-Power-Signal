...
The cable subsystem is responsible for transmitting the output of the Bias Tee on the transmitting side of the ComCaP to the Bias Tee on the recieving side of the ComCap. With that, Siemens also wants detailed simulations 
